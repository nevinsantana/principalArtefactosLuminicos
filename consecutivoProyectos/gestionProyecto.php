...
<div class="editaProyecto" id="editaProyecto">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" title="Referencia a cotización">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $idUsuario ?>" title="Usuario"
      disabled>
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $idNumCliente ?>" title="Cliente">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $nombreProyecto ?>"
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $fecha ?>">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $estado; ?>" title="Estado">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $municipio; ?>" title="Municipio">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $colonia; ?>" title="Colonia">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $calle; ?>" title="Calle">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
      <i class="fa fa-fw fa-road icon icon--kohana-eProyecto"></i>
      <span class="input__label-content input__label-content--kohana">
        Calle
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $numInt; ?>" title="No Interior">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $numExt; ?>" title="No Exterior">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $cp; ?>" title="Código postal">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
  ...
  <span class="input input--kohana-eProyecto">
    <input class="input__field input__field--kohana-eProyecto" type="text"
      name="idProyecto" value="<?php echo $notas; ?>" title="Notas">
    <label class="input__label input__label--kohana-eProyecto" for="input-29">
    ...
    <div id="aNota"><i class="fa fa-fw fa-floppy-o vCIcon"></i></div>
  </span>
