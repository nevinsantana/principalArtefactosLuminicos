...
<html>
    ...
    <body>
        <div id="header">
            <div align="center"><h1 style="text-align: center;">Artefactos Lumínicos SA de CV</h1></div>
        </div>
        ...
        <div style="margin-top: 70px;" align="center">
            <form action="descuentos2.php" method="POST">
                <div style="font-size: 16px;">
                    <div class="textoPartidas">Ingrese el descuento en porcentaje <input type="number"  name="descuento" style="width:50px; height:20px" step="0.01" min="0" max="100" required> %</div>
                </div>
