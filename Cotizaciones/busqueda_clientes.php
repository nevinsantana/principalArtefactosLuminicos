...
<div class="datagrid">
    <table width="1000px"> 
        ...
        $cont = 2;
        if ($permiso == 2) {
            $sql = "select * from Clientes where id_cliente like '%$rfc%' AND id_usuario = '$usuario' AND desactivado = 0 ORDER BY empresa";
        } else {
            $sql = "select * from Clientes where id_cliente like '%$rfc%' AND desactivado = 0 ORDER BY empresa";
        }
        $resultado = query($sql, $conexion);
