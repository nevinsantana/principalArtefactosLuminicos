...
$sql10="UPDATE Partidas SET no_partida='$orden10' WHERE id_partida=
  '$catalogo10'";
$resultadoa=query($sql10, $conexion);
$sql11="UPDATE Partidas SET no_partida='$orden11' WHERE id_partida=
  '$catalogo11'";
$resultadoa=query($sql11, $conexion);
$sql12="UPDATE Partidas SET no_partida='$orden12' WHERE id_partida=
  '$catalogo12'";
$resultadoa=query($sql12, $conexion);
$sql13="UPDATE Partidas SET no_partida='$orden13' WHERE id_partida=
  '$catalogo13'";
$resultadoa=query($sql13, $conexion);
$sql14="UPDATE Partidas SET no_partida='$orden14' WHERE id_partida=
  '$catalogo14'";
$resultadoa=query($sql14, $conexion);
$sql15="UPDATE Partidas SET no_partida='$orden15' WHERE id_partida=
  '$catalogo15'";
$resultadoa=query($sql15, $conexion);
$sql16="UPDATE Partidas SET no_partida='$orden16' WHERE id_partida=
  '$catalogo16'";
$resultadoa=query($sql16, $conexion);
$sql17="UPDATE Partidas SET no_partida='$orden17' WHERE id_partida=
  '$catalogo17'";
$resultadoa=query($sql17, $conexion);
$sql18="UPDATE Partidas SET no_partida='$orden18' WHERE id_partida=
  '$catalogo18'";
$resultadoa=query($sql18, $conexion);
$sql19="UPDATE Partidas SET no_partida='$orden19' WHERE id_partida=
  '$catalogo19'";
$resultadoa=query($sql19, $conexion);
$sql20="UPDATE Partidas SET no_partida='$orden20' WHERE id_partida=
  '$catalogo20'";
$resultadoa=query($sql2, $conexion);
?>
<!doctype html >
