...
{	
	...
	switch (u)
		...
		case "0": l="cero pesos";
		break;
		case "1": if (ax==0){l="uno pesos";}else{l="una";}
		break;
		case "2": l="dos  pesos";
		break;
		case "3": l="tres pesos";
		break;
		case "4": l="cuatro pesos";
		break;
		case "5": l="cinco pesos";
		break;
		case "6": l="seis pesos";
		break;
		case "7": l="siete pesos";
		break;
		case "8": l="ocho pesos";
		break;
		case "9": l="nueve pesos";
		break;
		}
}		
...
var deci=new Array(""," d&eacute;cimas"," centavos"," mil&eacute;simas"," diezmil&eacute;simas"," cienmil&eacute;simas"," millon&eacute;simas"," diezmillon&eacute;simas"," cienmillon&eacute;simas"," milmillon&eacute;simas")
ax=0;
while(bb[ax])
{
if (ax==0){l=bb[0];}
