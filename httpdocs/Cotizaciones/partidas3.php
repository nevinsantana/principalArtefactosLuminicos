...
//Agregar Campos en la Tabla Cotizaciones
$sqla = "UPDATE `Datos_Cotizacion` SET id_cotizacion='$id_cotizacion', datos_cliente='$string', `datos_contacto`='$string2',`datos_vendedor`='$string3' WHERE `id_cotizacion`='$id_cotizacion'";
