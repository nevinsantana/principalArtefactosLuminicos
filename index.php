...
<html lang="es_mx">
  ...
  <body id="body" onresize="normaliza()" onload="aparecePagina()" onunload="desaparecePagina()">
    ...
    <div id="wrapper">
      <header>
        <a href="http://www.artefactosluminicos.com.mx"><img id="logo"
        src="images/logoIndex.png"/></a><br><br><br>
        <div id="DivPhone">
      ...
      <footer>
        ...
        <div id="footer2" >
          <div id="contenedorCopy">
            ...
            <p id="texto9">
            <a href="http://www.artefactosluminicos.com.mx/attachments/File/AvisoPrivacidad.pdf">
              Aviso de Privacidad
            </a>
            </p>
          </div>
